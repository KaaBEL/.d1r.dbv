...
"use strict";
/** @readonly */
var version_editor_js = "v.0.2.8.1";
...
Tool.Tab.addCSS("position: absolute;top: 0px;right: 0px;width: 300px;height:\
 500px;border: 2px solid rgb(85, 119, 170);border-radius: 7px;font-family:\
 sans-serif;background-color: rgb(13, 33, 55);color: rgb(187, 204, 221);\
 opacity: .7;", "");
...
Tool.Tab.addItem("Node", function setup(methods, x, y) {
  ...
  methods.append("article#juhus.hehes.xd.", function () {});
